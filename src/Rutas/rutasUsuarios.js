...
router.get('/buscarUsuario', controladorUsuarios.buscarUsuario);
router.post('/guardarUsuario', body('personas_id').isInt().withMessage('Debe enviar valores enteros'),
...
router.put('/modificarUsuario', controladorUsuarios.modificarUsuario);
